...
namespace BNG {
    ...
    public class GrabbableEditor : Editor {
        ...
        SerializedProperty keepOriginalParent;
        ...
        void OnEnable() {
            ...
            keepOriginalParent = serializedObject.FindProperty("KeepOriginalParent");
        ...
        public override void OnInspectorGUI() {
            ...
            EditorGUILayout.PropertyField(keepOriginalParent);
