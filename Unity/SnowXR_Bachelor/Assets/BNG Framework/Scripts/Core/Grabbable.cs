...
namespace BNG {
    ...
    public class Grabbable : MonoBehaviour {
        ...
        /// <summary>
        /// Should the object be set as a child under its original parent upon dropping the object.
        /// </summary>
        [Tooltip("Should the object be set as a child under its original parent upon dropping the object.")]
